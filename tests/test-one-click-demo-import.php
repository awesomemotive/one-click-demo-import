...
class OneClickDemoImportTest extends WP_UnitTestCase {
	...
	function test_plugin_files_exists() {
		...
		$this->assertFileExists( PT_OCDI_PATH . 'vendor/humanmade/WordPress-Importer/class-logger-cli.php', 'WP importer v2 logger CLI file is missing!' );
		$this->assertFileExists( PT_OCDI_PATH . 'vendor/humanmade/WordPress-Importer/class-logger.php', 'WP importer v2 logger file is missing!' );
		$this->assertFileExists( PT_OCDI_PATH . 'vendor/humanmade/WordPress-Importer/class-wxr-importer.php', 'WP importer v2 main file is missing!' );
	}
}
