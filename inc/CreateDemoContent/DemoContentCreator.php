	...
	public function get_default_content() {
		return array(
			array(
				...
				'description'      => esc_html__( 'Looking for an About page template, with a great layout? This is the page for you.', 'one-click-demo-import' ),
			...
			array(
				...
				'description'      => esc_html__( 'A fully functional contact page with existing contact form by WPForms.', 'one-click-demo-import' ),
			...
			array(
				...
				'description'      => esc_html__( 'Creating a service business site? You\'ll probably need a booking page, right?', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'faq-page',
				'name'             => esc_html__( 'FAQ', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Almost every website should have a Frequently Asked Questions page. Use this one to save time!', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'meet-the-team-page',
				'name'             => esc_html__( 'Meet the Team', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Want to present your team in the best way possible? Use our Meet the Team page.', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'menu-page',
				'name'             => esc_html__( 'Menu', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Running a restaurant and need a dining menu page?', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'portfolio-page',
				'name'             => esc_html__( 'Portfolio', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Showcase your achievements with our portfolio page.', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'services-page',
				'name'             => esc_html__( 'Services', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Display a pricing table for your service plans.', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'shop-page',
				'name'             => esc_html__( 'Shop', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Show your awesome products and great customer reviews.', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
			array(
				'slug'             => 'testimonials-page',
				'name'             => esc_html__( 'Testimonials', 'one-click-demo-import' ),
				'description'      => esc_html__( 'Add social proof to your site with great looking testimonials.', 'one-click-demo-import' ),
				'required_plugins' => array(),
			),
		);
	}
